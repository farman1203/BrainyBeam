...
/**
 * Displays a single property in a card. Used across Buyer / Agent listing pages.
 * Props:
 *  - property: property object from dummyData
 *  - detailsPath: base path for "View Details" link (defaults to /buyer/properties)
 *  - onSave: optional callback when the heart icon is clicked
 *  - onCompare: optional callback when the compare icon is clicked
 *  - saved: boolean, whether property is already saved
 */
