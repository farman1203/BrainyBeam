...
// import { properties, leads, siteVisits } from '../../data/dummyData'
...
//           <p className="page-subtitle">Welcome back, Rahul. Here's what's happening today.</p>
//         </div>
//         <Link
...
//             {myLeads.map((l) => (
//               <LeadStatusCard key={l.id} lead={l} />
//             ))}
//           </div>
//         </div>
...
//               <li key={v.id} className="agent-dashboard-visit-item">
//                 <p className="agent-dashboard-visit-buyer">{v.buyer}</p>
//                 <p className="agent-dashboard-visit-property">{v.property}</p>
//                 <p className="agent-dashboard-visit-time">{v.date} · {v.time}</p>
//               </li>
//             ))}
//           </ul>
//         </div>
