...
import { properties, formatPrice } from '../../data/dummyData'
    ...
    <div className="page-stack-6">
      ...
      {filtered.length === 0 ? (
        ...
        <div className="my-properties-grid">
          {paged.map((p) => (
            <div key={p.id} className="my-properties-card">
              ...
              <div className="my-properties-card-body">
                ...
                <div className="my-properties-card-actions">
                  <Link to={`/agent/properties/${p.id}`} className="my-properties-action-link">
                    <Eye size={13} /> View
                  </Link>
                  <Link to={`/agent/properties/edit/${p.id}`} className="my-properties-action-link">
                    <Pencil size={13} /> Edit
                  </Link>
                  <button className="my-properties-delete-btn">
                    <Trash2 size={13} />
                  </button>
                </div>
              </div>
