...
export default function AgentProfile() {
  const user = currentUser.agent
  const [form, setForm] = useState({ name: user.name, email: user.email, phone: user.phone, bio: 'Helping families find their dream homes across Ahmedabad for over 5 years.' })
  ...
  return (
    <div className="profile-page page-stack-6">
      <div className="profile-header">
        ...
        <p className="page-subtitle">Manage your agent profile information.</p>
      </div>
      ...
      <div className="profile-card">
        <div className="profile-top-row">
          ...
          <div>
            ...
            <span className="profile-role-badge profile-role-badge--agent">Agent</span>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="profile-form">
          ...
          <div>
            ...
            <textarea name="bio" rows={3} value={form.bio} onChange={handleChange} className="form-field-input resize-none" />
          </div>
