...
import { amenitiesList, cities, propertyTypes } from '../../data/dummyData'
import './PropertyForm.css'

/**
 * Reusable form for creating / editing a property listing.
 * Props:
 *  - initialData: property object to pre-fill (for edit mode)
 *  - onSubmit: callback(formValues)
